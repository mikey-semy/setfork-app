  ...
  ...next,
  {
    rules: {
      ...
      'no-restricted-syntax': [
        ...
        {
          selector: 'Literal[value=/text-\\u005B\\d+(\\.\\d+)?px\\u005D|text-\\u005B(0\\.5625|0\\.59375|0\\.625|0\\.65625|0\\.71875|0\\.75|0\\.84375|0\\.90625|0\\.9375|1\\.0625|1\\.1875)rem\\u005D/]',
          message: 'Кегль вне лестницы ролей (rem-ступени 0.6875/0.78125/0.8125/0.875/1/1.125 + герои ≥1.25rem; px запрещён — размеры в rem ради настройки масштаба) — возьми роль из shared/ui/control.ts (TEXT).',
        },
        {
          selector: 'TemplateElement[value.cooked=/text-\\u005B\\d+(\\.\\d+)?px\\u005D|text-\\u005B(0\\.5625|0\\.59375|0\\.625|0\\.65625|0\\.71875|0\\.75|0\\.84375|0\\.90625|0\\.9375|1\\.0625|1\\.1875)rem\\u005D/]',
          message: 'Кегль вне лестницы ролей (rem-ступени 0.6875/0.78125/0.8125/0.875/1/1.125 + герои ≥1.25rem; px запрещён — размеры в rem ради настройки масштаба) — возьми роль из shared/ui/control.ts (TEXT).',
        },
      ],
