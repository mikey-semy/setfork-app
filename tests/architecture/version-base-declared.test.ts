...
describe('текущая версия у MCP считается одним правилом', () => {
  ...
  const CONTRACT_POINTS: Record<string, number> = {
    ...
    // `publish_skill` СВЕРЯЕТ присланное и читает файлы автора той же версии, с которой
    // сливает набор: слияние с файлами другой версии стёрло бы или вернуло не те.
    'tools/lists/skill.ts': 1,
