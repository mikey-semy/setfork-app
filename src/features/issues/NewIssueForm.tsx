...
const inputCls = 'px-3 py-2 text-[0.875rem]'
    ...
    >
      ...
      <div>
        ...
        <div className={`grid overflow-hidden transition-all duration-200 ${error ? 'mt-1.5 grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}>
          <p className="min-h-0 overflow-hidden text-[0.78125rem] text-danger">{t('titleRequired', lang)}</p>
        </div>
      </div>
      ...
      <div>
        <div className="mb-1.5 text-[0.78125rem] font-semibold text-ink-2">{t('labelsLabel', lang)}</div>
