  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="w-full max-w-[360px] overflow-hidden rounded-xl border border-border bg-surface shadow-2xl"
          ...
          >
            ...
            <div className="p-4">
              <div className="flex items-center gap-2">
                ...
                {open.tier > 1 && (
                  <span className="rounded bg-warn/15 px-1.5 py-0.5 font-mono text-[12px] font-semibold text-warn">×{open.tier}</span>
                )}
              </div>
                  ...
                  {open.tiers.map((th, i) => {
                    ...
                    return (
                      <li key={th} className="flex items-center gap-2 text-[12.5px]">
                        ...
                        {reached && <span className="ml-auto font-mono text-[11px] text-ok">✓</span>}
                      </li>
                    )
                  })}
                </ul>
