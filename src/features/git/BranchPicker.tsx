    ...
    <div className="relative inline-block">
      ...
      {open && (
        <>
          ...
          <div className="animate-sf-pop absolute left-0 top-full z-50 mt-1.5 w-panel-lg cap-viewport overflow-hidden rounded-lg border border-border bg-surface shadow-card">
            <PickerPanel
