...
const REASON_TO_CODE: Record<string, BranchOpError['code']> = {
  ...
  // ДВА разных случая, и человеку они говорят разное: связь сорвалась (повтор
  // осмыслен) против «ответ не разобран» (разошлись версии, повтор бесполезен).
  // До 26.08.2026 оба ехали в 'internal' с текстом «попробуйте ещё раз» — для
  // второго это прямо вредный совет.
