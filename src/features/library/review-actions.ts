...
// Чтение ревью живёт в review-queries.ts (без 'use server'): клиент его не зовёт, а
// экспорт отсюда был бы сетевой точкой входа с любым id правки — см. линза 02, F2.
