...
function networks(u: string, text: string) {
  ...
  return [
    ...
    { name: 'WhatsApp', href: `https://wa.me/?text=${encodeURIComponent(`${text} ${u}`)}` },
    ...
    { name: 'Reddit', href: `https://www.reddit.com/submit?url=${eu}&title=${et}` },
  ]
}
