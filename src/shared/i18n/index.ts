...
const DICT = {
  ...
  featIssues: { en: 'Issues', ru: 'Задачи (Issues)' },
  ...
  aiDraft: { en: 'Gnome draft', ru: 'черновик от гномов' },
  generateWithAi: { en: 'Dream up a list', ru: 'Придумать список' },
  cantFind: { en: "Can't find it?", ru: 'Не нашёл?' },
  aiFail: { en: "The gnomes came up empty — try rephrasing.", ru: 'У гномов не вышло — переформулируй запрос.' },
  rateLimited: { en: 'Too many requests. Try again in a minute.', ru: 'Слишком часто. Попробуй через минуту.' },
  aiVerifyHint: {
    en: 'Drafted by the gnomes — review, refine and star it so it becomes a proven reference.',
    ru: 'Черновик от гномов — проверьте, доработайте и отметьте звездой, чтобы он стал эталоном.',
  },
  ...
  aiUsageIntro: {
    en: 'How much the gnomes drafted and refined for you on SetFork.',
    ru: 'Сколько гномы придумали и доработали для вас на SetFork.',
  },
