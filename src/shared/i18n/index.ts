...
const DICT = {
  ...
  prDraftHint: { en: 'A draft cannot be merged — mark it ready when the work is done.', ru: 'Черновик нельзя слить — отметь готовность, когда правка дописана.' },
  ...
  tlOpened: { en: 'opened this suggestion', ru: 'предложил правку' },
  ...
  tlMerged: { en: 'merged this suggestion', ru: 'принял правку' },
  tlClosed: { en: 'closed this suggestion', ru: 'отклонил правку' },
  prMerged: { en: 'Suggestion merged and closed', ru: 'Правка принята и закрыта' },
  prClosed: { en: 'Suggestion closed without merging', ru: 'Правка отклонена' },
  ...
  reviewOwnAuthor: { en: 'You cannot review your own edit', ru: 'Свою правку не ревьюят' },
  ...
  notifReviewRequested: { en: 'requested your review in', ru: 'просит вас посмотреть правку в' },
