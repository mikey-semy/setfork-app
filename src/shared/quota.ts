...
// или коллективный абьюз). ВКЛЮЧЁН по умолчанию ($10/день). Измеренная цена (журнал ai_usage,
// 2026-07-18): совет ~$0.10/ген, одиночная ~$0.02 (РАННЯЯ оценка $0.0026 на 5 генерациях была
// занижена в ~40×, см. research/2026-07-18-unit-economics-and-tariffs). При ~$0.10/совет $10/день ≈
// 100 советов/день — покрывает первые десятки активных и тормозит утечку; под аудиторию поднимать
