...
/** Читаемая колонка ВНУТРИ страницы: формы и сплошной текст. Строка в 1180px
 *  не читается (норма — 60–80 знаков), поэтому форма остаётся узкой, а рамка
 *  страницы вокруг неё — общая. */
export const PAGE_COLUMN = 'mx-auto w-full max-w-[45rem]'
