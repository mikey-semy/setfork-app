 ...
 * хостов: исследование того же Google показало, что 94,7% политик-перечней обходятся
 * (Weichselbaum и др., «CSP Is Dead, Long Live CSP!», CCS 2016). Скрипт исполняется,
 ...
 * `https:` и `'unsafe-inline'` — запасной путь для браузеров без CSP3: при наличии
 * nonce современный браузер их игнорирует.
 *
