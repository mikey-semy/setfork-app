    ...
    return (
      <div className="flex flex-1 items-center justify-center px-4 py-16">
        <div className="w-full max-w-[26.25rem] rounded-lg border border-border bg-surface p-6 text-center">
          ...
          <div className="text-[1rem] font-bold text-ink">{ru ? 'Ссылка недействительна' : 'Link is invalid'}</div>
          <p className="mt-1 text-[0.8125rem] text-ink-2">
            {ru ? 'Ссылка истекла или уже использована.' : 'The link has expired or was already used.'}
          </p>
          <Link href="/forgot-password" className="mt-4 inline-block text-[0.8125rem] font-semibold text-accent hover:underline">
