...
export const MERGE_ERR: Record<string, TKey> = {
  ...
  // проверяются исполняемые команды, а «не прочитали» — не «команд нет». Обрыв
  // преходящий, поэтому текст зовёт повторить, а не чинить.
  'snapshot-unavailable': 'branch.errSnapshotUnavailable',
