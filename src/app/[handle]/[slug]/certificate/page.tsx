        ...
        {!session ? (
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="w-full overflow-hidden rounded-xl border-2 border-ok/50 bg-surface p-8 text-center shadow-card sm:p-12">
              ...
              <p className="mt-6 text-[13px] text-muted">{ru ? 'Настоящим подтверждается, что' : 'This certifies that'}</p>
            ...
            <div className="flex items-center gap-3 print:hidden">
              ...
              <Link href={base} className="text-[13px] text-accent hover:underline">
                {ru ? '← К курсу' : '← Back to the course'}
              </Link>
            </div>
          </div>
